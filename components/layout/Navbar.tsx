...
export default function Navbar() {
  ...
  return (
    <Header 
      className={`glass-nav fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-[5%] h-20 z-[1000] border-none leading-[80px] transition-all duration-300 ${scrolled ? 'scrolled bg-[var(--glass-bg)] shadow-sm' : 'bg-transparent'}`}
    >
